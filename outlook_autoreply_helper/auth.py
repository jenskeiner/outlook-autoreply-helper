...
def get_access_token(settings: AppRegistrationSettings, token_cache):
    """
    ...
    2. If no cached token is available, use either device code or interactive authentication flow

    Args:
        settings (AppRegistrationSettings): Application registration and authentication settings
